...
class ChatbotService:
    ...
    def _initialize_services(self):
        """Initialize AI services based on settings."""
    ...
    def _process_llama_only(self, query: str) -> Dict:
        """Process query using only LLaMA."""
        # Generate response without RAG or DistilBERT
    ...
    def _process_hybrid(self, query: str) -> Dict:
        ...
        # Step 3: LLaMA generation with context, entities, and intent
        # Uses advanced prompt engineering with few-shot examples and CoT
