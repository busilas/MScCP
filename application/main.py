...
def create_default_users():
    ...
    click.echo('  Username: user')
    click.echo('  Email: user@example.com')
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ['init_db', 'create_admin', 'drop_db', 'create_default_users']:
        # Run as Flask CLI command
